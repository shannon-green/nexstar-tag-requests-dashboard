(function () {
  ...
  function downloadCsv() {
    ...
    const headers = ["Client", "Script", "Site URL", "Status", "Assignee", "Client Address", "Nexstar Market", "RD", "Nexstar AE Name", "Nexstar AE Email", "Submitted Date", "Installed Date"];
  ...
  bulkDownloadTemplate.addEventListener("click", () => {
    const csv =
      "Client Name,Site URL,Client Address,Nexstar Market,Nexstar AE Name,Nexstar AE Email\n" +
