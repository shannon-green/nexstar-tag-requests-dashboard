(function () {
  ...
  function downloadCsv() {
    ...
    const headers = ["Client", "Script", "Site URL", "Status", "Assignee", "Client Address", "Client Contact Name", "Client Contact Email", "Nexstar Market", "RD", "Nexstar AE Name", "Nexstar AE Email", "Submitted Date", "Installed Date"];
