(function () {
  ...
  function render() {
    ...
    filterLabel.textContent = `Showing ${statusLabel}${marketLabel}${rdLabel} (${filtered.length})`;
  ...
  function downloadCsv() {
    ...
    const headers = ["Client", "Market", "RD", "Site URL", "Address", "Status", "Assignee", "Script", "Contact Name", "Contact Email", "Submitted", "Installed Date"];
